                        ...
                        <div style="padding: 0px">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <form method="post" action="${pageContext.request.contextPath}/user/login" name="form1"
                                        ...
                                        <table width="100%" border="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td>登录密码</td>
                                                <td><input type="password" id="mpass" name="u_password"
                                            ...
                                            <tr>
                                                ...
                                                <td height="40"><input name="imageField" type="image"
                                                                       src="${pageContext.request.contextPath}/qiantai/images/denglu.gif"
                                                                       border="0"/> <a
                                                        href="${pageContext.request.contextPath}/front/toreg"
                                                        style="padding-left: 1px"><img
                                                        src="${pageContext.request.contextPath}/qiantai/images/zhuce.gif"
                                                        alt="" width="40" height="19" border="0"/></a></td>
                                            </tr>
                                            <tr>
                                ...
                                <div
                                    ...
                                    <ul style="margin: 0px; padding: 0px">
                                        ...
                                        <li
                                                style="list-style-type: none; line-height: 30px; background: url(${pageContext.request.contextPath}/qiantai/images/cateitems.gif) left no-repeat; padding-left: 20px">
                                            如果您还没有注册会员，<a href="${pageContext.request.contextPath}/front/toreg"
                                                          target="_self"><font
                                                color="#FF6600">点这里注册新会员</font></a>
                                        </li>
                                        <li
                                                style="list-style-type: none; line-height: 30px; background: url(${pageContext.request.contextPath}/qiantai/images/cateitems.gif) left no-repeat; padding-left: 20px">
                                            如果您忘记了密码， <a href="${pageContext.request.contextPath}/front/tofindpassword"><font
                                                color="#99CC00">点这里重设一个密码</font></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>

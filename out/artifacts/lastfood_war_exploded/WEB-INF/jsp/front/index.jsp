                                            ...
                                            <div style="margin-top: 0px; padding: px;">
                                                ...
                                                <div id="mm_01" class="dingcanall_connow">
                                                    <table>
                                                        ...
                                                        <c:forEach items="${requestScope.allmenu }" var="menu"
                                                                   varStatus="status">
                                                                    ...
                                                                    <table>
                                                                        <tr>
                                                                            <td rowspan="5" class="bookPic"><a
                                                                                    href="${pageContext.request.contextPath}/menu/findmenubymid?m_id=${menu.m_id  }"><img
                                                                                    src="${pageContext.request.contextPath}/imgmenu/${menu.m_imgname }"
                                                                                    style="border: 1px solid #300; width: 150px; height: 140px"/></a>
                                                                            </td>
                                                                            <td><span>餐品名称:</span></td>
                                                                            <td>
                                                                                <span><strong>${menu.m_name }</strong></span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><span>店铺:</span></td>
                                                                            <td><span>${menu.store.s_shopname }</span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><span>餐品价格:</span></td>
                                                                            <td><span><strong
                                                                                    style="color: red;">${menu.m_price }</strong></span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><span>餐品销量:</span></td>
                                                                            <td><span>${menu.m_sales }</span></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><span>餐品类型:</span></td>
                                                                            <td><span>${menu.category.c_name }</span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan="2" style="height: 40px;"><a
                                                                                    href="${pageContext.request.contextPath}/cart/addtocart?m_id=${menu.m_id }"><img
                                                                                    src="${pageContext.request.contextPath}/qiantai/images/cart.png"
                                                                                    border="0"
                                                                                    alt=""/></a></td>
                                                                            <td></td>
                                                                        </tr>

...
<div style="width: 100%;height:48px; background-color:RGB(43,48,59) ">
      <ul style="margin-left: 40px;padding-top:6px">
        <li style="display: inline-block;"><h1><a href="loginForm.html" style="color:white;font-size:20px;">网上餐厅后台商户管理平台</a></h1></li>
        <li style="display: inline-block; margin-left: 120px;"><p style="font-size:14px;color: rgb(130,130,130)">重置密码</p></li>
        <li style="display: inline-block; margin-left: 60px;"><a href="${pageContext.request.contextPath}/after" style="font-size:14px;color:rgb(130,130,130); ">首页</a></li>
        <li style="display: inline-block; margin-left: 80px;"><a href="javascript:alert('本系统只提供管理员和商户管理人员登录系统！！！！');"	 style="font-size:14px;color:rgb(130,130,130); ">帮助与文档</a></li>
        <li style="display: inline-block; margin-left: 64px;"><p  style="font-size:14px;color:rgb(130,130,130);">客服电话：88888888</p></li>
      </ul>    
    </div> 
    <div id="main" style="width:100%;height:610px;float:left;">
		...
		<div class="register" style="height:360px;margin-top:150px;margin-left:205px; opacity:0.9;" >
            ...
            <form action="rePassword?s_loginname=${store.s_loginname}" method="post" id="rePasswordForm">
            <div style="height: 10px"></div>
            
             <div class="default">
                    <input id="loginname" name="s_loginname"   data-form="upwd" type="text" placeholder="请输入您的登录名 "  value="${store.s_loginname}" disabled="disabled"/>
             </div>
             
             <div class="default" style="margin-top: 16px;">
                    <input id="password" name="s_password" data-form="uname" type="password" placeholder="新密码" value=""/>
             </div>
              ...
              <div class="default" style="margin-top: 16px;">
                    <input id="repassword" name="s_repassword" data-form="uname" type="password" placeholder="请再次输入你的新密码"  value=""/>
             </div>
              <div style="height: 10px;margin-top: -10px;">

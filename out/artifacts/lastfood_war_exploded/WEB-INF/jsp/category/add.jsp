...
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="deptForm"  action="${pageContext.request.contextPath}/category/add">
        <%--<input type="hidden" name="id" id="id" value="${job.id }" >--%>
         ...
         <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                ...
                placeholder="输入餐品类别名"   autocomplete="off" class="layui-input" >
              </div>

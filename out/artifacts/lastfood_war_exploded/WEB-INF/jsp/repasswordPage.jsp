...
<div style="width: 100%;height:48px; background-color:RGB(43,48,59) ">
    <ul style="margin-left: 40px;padding-top:6px">
        ...
        <li style="display: inline-block; margin-left: 120px;"><p style="font-size:14px;color: rgb(130,130,130)">
            找回密码</p></li>
        ...
        <div class="register" style="height:360px;margin-top:150px;margin-left:205px; opacity:0.9;">
            <div class="title">
                ...
                <div style="height: 10px;margin-top:15px;">
                    <input id="find_message" disabled="disabled" size="50px;" value=""
            ...
            <form action="toFindPassword" method="post" id="toPasswordForm">
                ...
                <div class="default">
                    <input id="loginname" name="s_loginname" data-form="upwd" type="text" placeholder="请输入您的登录名 "
                           onchange="checkLoginname()" value=""/>
                </div>
                ...
                <div class="default" style="margin-top: 16px;">
                    <input id="username" name="s_fullname" data-form="uname" type="text" placeholder="请输入您的用户名"
                           onchange="checkUsername()" value=""/>
                </div>
                <div style="height: 10px;margin-top: -10px;">
                ...
                <div class="default">
                    <input id="user_input_verifyCode" name="user_input_verifyCode" style="width:100px;"

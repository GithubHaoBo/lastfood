    ...
    <div class="x-body">
        ...
        <input type="hidden" name="id" id="id" value="${job.id }" >
         ...
         <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                ...
                placeholder="输入员工姓名"   autocomplete="off" class="layui-input" >
              </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="e_phone" required="" lay-verify="required"
                           placeholder="输入电话"   autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="e_salary" required="" lay-verify="required"
                           placeholder="输入月薪"   autocomplete="off" class="layui-input">
                </div>
            </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="email" name="e_email" required="" lay-verify="required"
                placeholder="请输入QQ邮箱"   autocomplete="off" class="layui-input">
              </div><br>
              <p style="color: red;margin-left:40px;">${message}</p>

    <%@ page language="java" contentType="text/html; charset=UTF-8"
        ...
        action="${pageContext.request.contextPath}/menu/add">
        ...
        placeholder="输入餐品名" autocomplete="off" class="layui-input" >
        </div>
        ...
        placeholder="输入配料" autocomplete="off" class="layui-input">
        </div>
        </div>
        ...
        placeholder="输入餐品描述" autocomplete="off" class="layui-input">
        </div>
        </div>
        ...
        placeholder="输入价格" autocomplete="off" class="layui-input">
        </div>
        </div>
        <div class="layui-form-item">
        <label for="username" class="layui-form-label">
        ...
        /imgmenu/imgnull.jpg" style="width: 150px;height: 150px"> <input id="upload" name="file"

...
<div style="width: 100%;height:48px; background-color:RGB(43,48,59) ">
    <ul style="margin-left: 40px;padding-top:6px">
        <li style="display: inline-block;"><h1><a href="loginForm.html" style="color:white;font-size:20px;">网上餐厅后台商户管理平台</a>
        </h1></li>
        <li style="display: inline-block; margin-left: 120px;"><a href="${pageContext.request.contextPath }/front"
                style="font-size:14px;color:rgb(130,130,130); ">用户前台</a></li>
        <li style="display: inline-block; margin-left: 60px;"><a href="${pageContext.request.contextPath}/after" style="font-size:14px;color:rgb(130,130,130); ">首页</a>
        </li>
        <li style="display: inline-block; margin-left: 80px;"><a
                href="javascript:alert('本系统只提供管理员和商户管理人员登录系统！！！');"
            ...
            <div class="title">
                ...
                <div style="height: 10px;margin-top:15px;">
                    <input id="span_id" disabled="disabled" value=""
                           style="background-color:transparent;border:0;color: red" size="45"/>
                </div>
            </div>  <!--  -->
            <form method="post" action="login" name="check-form" id="toLoginForm">

                <div class="default" style="margin-top:40px;">
                    <input data-form="uname" type="text" placeholder="请输入登录名" onchange="tocheckLoginname()"
                           id="loginname" name="s_loginname" value="${user.loginname}"/>
                </div>
                ...
                <div class="default">
                    <input id="password" name="s_password"
                           <%--value="${user.password}"--%>
                           value="aaa111" data-form="upwd" type="password" placeholder="请输入账号密码 "/>
                </div>

                <div class="default">
                    <input id="user_input_verifyCode" name="store_input_verifyCode" style="width:100px;"
                    ...
                    <div class="vcode" id="vcodeDiv" style="float: right;">
                        ...
                        <a id="changeVerifImageRegister" href="javascript:void(0);" onclick="javascript:changeImage();"
                           title="验证码看不清？点击获取新验证码">看不清图片？</a>
                        <input name="code" type="hidden" id="code" value="dologin"/>
                    </div>
                </div>
                <div class="submit" style="margin-top: 12px;">

                    <a href="javascript:;" onclick="location.href='./toregist';" style="">没有账号？立即注册</a>

                    <span class="notice">
                        
                          <a href="javascript:;" onclick="location.href='./repassword';">忘记密码</a>
                        </span>
                    <button type="button" id="login-submit-btn" class="s_hover" onclick="checkLoginnameAndPassword()">
                        安全登录
                    </button>
                </div>
            </form>

...
<div class="x-body">
    <form class="layui-form" enctype="multipart/form-data" method="POST" id="deptForm"
        ...
        <input type="hidden" name="n_id" id="id" value="${notice.n_id }" >
        <input type="hidden" name="n_imgname"  value="${notice.n_imgname }" >
        <input type="hidden" name="n_time"  value="${notice.n_time }" >
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="username" name="n_title" required="" lay-verify="required"
                       placeholder="输入公告标题" autocomplete="off" class="layui-input" value="${notice.n_title}">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea style="width: 500px;" name="n_content" placeholder="输入公告内容" class="layui-textarea">${notice.n_content}</textarea>
            </div>
        </div>
        ...
        /imgnotice/${notice.n_imgname}" style="width: 250px;height: 200px"> <input id="upload" name="file"
